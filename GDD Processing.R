---
Title: "GDD Processing"
Project: "Texas & Georgia Agriculture"
Date: "March 4, 2025"
CodeContact: "Nick Grener, grener@gmail.com"

Inputs: "All .csv files in GA_PRISM and TX_PRISM folders for districts of interest obtained from
PRISM Climate Group, Oregon State University. PRISM Monthly Average Temperature, Minimum Temperature and Maximum Temperature datasets (AN91d).  
Accessed [02-21-2025], https://prism.oregonstate.edu/PRISM_Datasets.pdf"

Outputs: "GA_benchmarks.csv, TX_benchmarks.csv, GA_monthly.csv, TX_monthly.csv"

Description: 
"Creates two different summary GDD calculations at the NASS District level for each state; 
the _benchmark files find the day of the year in each county at which five cotton growth benchmarks are met,
then averages those days of the year out at the district level. The _monthly files find the monthly
GDD in each county and average those values out across the district, as well as averaging out cumulative
GDD through the end of each month."
---
